...
public class Home {
	...
	private void initialize() {
		...
		HbtnHome.setBounds(0, 46, 186, 30);
		...
		HbtnCarPa.setBounds(186, 46, 186, 30);
		...
		HbtnCarRe.setBounds(372, 46, 186, 30);
		...
		HbtnLogout.setBounds(558, 46, 187, 30);
		...
		lblNewLabel_1.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\a-f.jpg"));
