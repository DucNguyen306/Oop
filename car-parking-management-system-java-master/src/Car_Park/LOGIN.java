...
//				}
		...
		LoginIcon.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\ll.png"));
		LoginIcon.setBounds(84, 42, 250, 350);
		frmLogIn.getContentPane().add(LoginIcon);
		
		JLabel CarIcon = new JLabel("");
		CarIcon.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\Car-icgon.png"));
