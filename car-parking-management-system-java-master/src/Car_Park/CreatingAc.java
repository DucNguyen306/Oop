...
//				}
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\logo.png"));
		lblNewLabel.setBounds(23, 0, 50, 65);
		frmCreatAccount.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\ppp.jpg"));
