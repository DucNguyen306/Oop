...
public class CarParking {
	...
	private void initialize() {
		...
		CPbtnHome.setBounds(0, 46, 186, 30);
		...
		CPbtnCarPa.setBounds(186, 46, 186, 30);
		...
		CPbtnCarRe.setBounds(372, 46, 186, 30);
		...
		CPbtnLogout.setBounds(558, 46, 187, 30);
		frmCarParking.getContentPane().add(CPbtnLogout);
		
		JLabel label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\logo 2.png"));
...
//					}
		...
		lblNewLabel.setIcon(new ImageIcon("D:\\OOP\\CAR\\car-parking-management-system-java-master\\picture\\caryt.jpg"));
